	...
	<div class="container footer-main footer-main-v5">
		...
		<nav aria-label="<?php echo esc_attr( $food_english ? 'Footer links' : 'Enlaces del pie' ); ?>">
			<ul class="footer-links-v5">
				<li><a href="<?php echo esc_url( function_exists( 'food_editorial_page_url' ) ? food_editorial_page_url( 'about', $food_footer_language ) : home_url( '/sobre-pometum/' ) ); ?>"><?php echo esc_html( $food_english ? 'About' : 'Acerca de' ); ?></a></li>
