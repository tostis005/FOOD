...
<header class="site-header">
	<div class="container header-main">
		...
		<div class="header-actions">
			...
			<button class="menu-toggle" type="button" aria-controls="mobile-menu-overlay" aria-expanded="false">
...
<div class="mobile-menu-overlay" id="mobile-menu-overlay" aria-hidden="true">
	<div class="mobile-menu-shell">
		<div class="mobile-menu-top">
			...
			<button class="mobile-menu-close" type="button" aria-label="<?php esc_attr_e( 'Cerrar menú', 'food' ); ?>"></button>
		</div>
		...
		<div class="mobile-menu-content">
			...
			<form class="mobile-menu-search" role="search" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>">
				...
				<input id="mobile-food-search" type="search" name="s" placeholder="Busca una duda sobre alimentos…" value="<?php echo esc_attr( get_search_query() ); ?>">
				<button type="submit">Buscar</button>
			</form>

			<p class="mobile-menu-note">Guías claras para elegir, conservar, cocinar y entender mejor lo que comes.</p>
		</div>
	</div>
</div>
